...
public class G {
    ...
    static boolean row(int n, int m, int a, int b, int[][] ans){// this means a < b so that we arrange by a
        int[] col = new int[m];
        for (int i = 0; i < n; i++) {
            int cnt = 0;
            for (int j = 0; j < m; j++) {
        ...
        for (int i = 0; i < m; i++) {
            if (col[i] != b) return false;
        }
        return true;
    }

    static boolean col(int n, int m, int a, int b, int[][] ans){ // this means a > b so that we arrange by b
        int[] row = new int[n];
        for (int j = 0; j < m; j++) {
            int cnt = 0;
            for (int i = 0; i < n; i++) {
